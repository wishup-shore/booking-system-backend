...
from app.schemas.accommodation import (
    AccommodationTypeCreate, AccommodationTypeUpdate,
...
class AccommodationTypeService:
    ...
    def get_by_id(self, accommodation_type_id: int) -> Optional[AccommodationType]:
        return self.db.query(AccommodationType).filter(
            AccommodationType.id == accommodation_type_id
        ).first()
    
    def create(self, accommodation_type_data: AccommodationTypeCreate) -> AccommodationType:
        db_accommodation_type = AccommodationType(**accommodation_type_data.model_dump())
        self.db.add(db_accommodation_type)
        self.db.commit()
        self.db.refresh(db_accommodation_type)
        return db_accommodation_type
    
    def update(self, accommodation_type_id: int, accommodation_type_data: AccommodationTypeUpdate) -> AccommodationType:
...
class AccommodationService:
    ...
    def update(self, accommodation_id: int, accommodation_data: AccommodationUpdate) -> Accommodation:
