...
class Accommodation(Base):
    ...
    status = Column(
        Enum(AccommodationStatus), default=AccommodationStatus.AVAILABLE, nullable=False
    )
    condition = Column(
        Enum(AccommodationCondition), default=AccommodationCondition.OK, nullable=False
    )
